...
本游戏包含9张研究图片。图片未因收入游戏而改变许可；下列署名、原作链接和许可也保留在游戏图注及放大阅读窗口中。请按各素材的独立条款使用，不将整个作品视为采用同一许可。
...
以下画稿使用ChatGPT图片生成功能生成，并根据研究史逐格审校。人物为文学化描绘；实验形象、机制和地图可能简化，不是历史现场照片、实测读数或论文原图。游戏按本页分格显示，完整科学图像及其原许可另行保留。插画不沿用旁边科学照片或论文图的许可。

- 恐龙灭绝 第1–16页：dinosaur-sheet-0.webp，1536×1024。
- 恐龙灭绝 第17–32页：dinosaur-sheet-1.webp，1536×1024。
- 恐龙灭绝 第33–48页：dinosaur-sheet-2.webp，1536×1024。
- Karikó与mRNA 第1–16页：mrna-sheet-0.webp，1536×1024。
- Karikó与mRNA 第17–32页：mrna-sheet-1.webp，1536×1024。
- Karikó与mRNA 第33–48页：mrna-sheet-2.webp，1536×1024。
