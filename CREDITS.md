...
原有恐龙与mRNA故事各有48个图文小页，同一科学图像可随线索再次出现。科学资料图片保留来源与用途说明；照片在阅读窗口中可能局部显示，展开原图可查看完整构图。论文图与图解完整显示。图片年代、拍摄对象与本幕情节可能不同，游戏中保留明确说明。图解及概念画不冒充历史照片或实测数据。
...
以下画稿使用GPT图像生成功能生成，用于表现研究场景、实验条件与线索关系。人物和器材是依据研究背景绘制的示意，实验形象、机制和空间关系可能简化，不是历史现场照片、实测读数或论文原图。游戏与放大窗口均只展示当前页的裁格，完整科学资料图及其原许可另行保留。插画不沿用旁边科学照片或论文图的许可；精确条件、读数与来源以本页的文字标注和所引资料为准。

- 薄层之下 第1–16页：dinosaur-sheet-0.webp，1536×1024。
- 薄层之下 第17–32页：dinosaur-sheet-1.webp，1536×1024。
- 薄层之下 第33–48页：dinosaur-sheet-2.webp，1536×1024。
- 一封引起警报的信 第1–16页：mrna-sheet-0.webp，1536×1024。
- 一封引起警报的信 第17–32页：mrna-sheet-1.webp，1536×1024。
- 一封引起警报的信 第33–48页：mrna-sheet-2.webp，1536×1024。
...
八篇各36页的调查保留288幅原创SVG图解。建议路线前两关“聪明汉斯”与“氩”的阅读画面更新为GPT生成插画后，原有图解仍可从相关科学资料入口查看，其余六关继续使用逐页图解。图中人物、器材、路径和空间关系经过简化；不是历史照片、论文原图或真实实验录像。原始读数与教学示例在正文中区分，来源入口逐幕保留。
